setwd("/mnt/disk1/6/lxk/private/DNase-C/dimer_paper/fig4/spDamID/enrichment/R2/")

library(tidyverse)

df <- read.table("DamID_R1_CTCFmotif_profile.tab", sep = "", header = FALSE, skip = 2)
...
pdf("enrichment.pdf", width = 3.2, height = 2.5, bg = "transparent")
