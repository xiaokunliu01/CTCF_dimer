setwd(dir = "/mnt/disk1/6/lxk/private/DNase-C/dimer_paper/fig1/293T/CTCF_HiChIP/R2/")
...
pdf("interaction_footprint_50-_d.pdf", width = 2.5, height = 2.0, bg = "transparent")

ggplot(data = df, mapping = aes(x=abs(df[,4])+abs(df[,5]), y=df[,9], fill=df[,9], color=df[,9])) + 
