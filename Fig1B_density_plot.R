setwd(dir = "/home/lxk/private/DNase-C/dimer_paper/fig1/293T/DNaseC/R2/")
library(dplyr)
library(tidyverse)
library(ggpubr)
...
ggplot(df, aes(x=df[,3], y=df[,2])) +
  ...
  annotate("text", x=-35, y=45, label="30.8%", colour = "red",size = 12*0.3528) + 
  annotate("text", x=35, y=45, label="24.5%",size = 12*0.3528) + 
  annotate("text", x=-35, y=-45, label="24.7%",size = 12*0.3528) + 
  annotate("text", x=35, y=-45, label="20.0%",size = 12*0.3528) + 
