setwd(dir = "/home/lxk/private/DNase-C/dimer_paper/fig5/spDamID/enrichment/R2/")

library(ggplot2)
library(reshape2)

df <- read.table("CC_CCd30_count_norm.bed", sep = "\t", header = FALSE)
...
pdf("fig4_heatmap_40bp.pdf", width = 1.0, height = 3.3, bg = "transparent")
